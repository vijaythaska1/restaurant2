...
export function Footer() {
  return (
    <footer className="mt-auto bg-[#1A1A2E] text-white" role="contentinfo">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 border-b border-white/10 text-center md:text-left">
          <div className="flex flex-col sm:flex-row items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F4651A] text-white shadow-lg" aria-hidden="true">
          ...
          <nav className="flex flex-wrap items-center justify-center gap-4 text-xs sm:text-sm font-bold text-white/80" aria-label="Footer navigation">
            <div className="flex items-center gap-2 rounded-full bg-white/5 px-4 py-2 border border-white/10">
              <Phone className="h-4 w-4 text-[#F4651A]" aria-hidden="true" />
              <a
                href={`tel:${STORE_CONFIG.phone1}`}
                className="hover:text-white transition-colors"
                aria-label={`Call us at ${STORE_CONFIG.phone1}`}
              >
                {STORE_CONFIG.phone1}
              </a>
              ...
              <a
                ...
                className="hover:text-white transition-colors"
                aria-label={`Call us at ${STORE_CONFIG.phone2}`}
              >
                {STORE_CONFIG.phone2}
              </a>
            </div>
            ...
            >
              <ShieldCheck className="h-4 w-4 text-[#F4651A]" aria-hidden="true" />
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/40 text-center">
          ...
          <p className="flex items-center justify-center gap-1">
            ...
            <Heart className="h-3 w-3 fill-[#F4651A] text-[#F4651A]" aria-hidden="true" />
